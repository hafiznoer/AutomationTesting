...
//Set Nama
WebUI.setText(findTestObject('Nobu Screen Update/Text_nama'), 'Nur Eka Rahman')

//Set NIK
WebUI.setText(findTestObject('Nobu Screen Update/Text_NIK'), 'N02558')

//Set Divisi
WebUI.setText(findTestObject('Nobu Screen Update/Text_Divisi'), 'Merchant Business')
...
// Lokasi Kerja
WebUI.setText(findTestObject('Nobu Screen Update/Text_Lokasi Sekarang'), 'WFO')
...
//Rapid
WebUI.setText(findTestObject('Nobu Screen Update/text_Rapid'), 'Tidak')
